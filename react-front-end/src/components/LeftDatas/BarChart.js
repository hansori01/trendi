...
export default function SentiBarChart() {
  return (
    <BarChart
      ...
      <Bar dataKey={3} fill="#1cb48e" barSize={20}/>
      {/* <Bar dataKey={2} fill="#128f70" /> */}
      <Bar dataKey={1} fill="#0d634d" barSize={20}/>
      <Bar dataKey={0} fill="#697471" barSize={20}/>
      {/* <Bar dataKey={11} fill="#BA3B61" /> */}
      <Bar dataKey={12} fill="#d84a74" barSize={20}/>
      {/* <Bar dataKey={13} fill="#ec336b" /> */}
      <Bar dataKey={14} fill="#e41956" barSize={20}/>
      <Bar dataKey={15} fill="#fa044e" barSize={20}/>
      <XAxis dataKey="name" />
